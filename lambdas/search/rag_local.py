...
def rag_query(tenant_id, query_text, top_n=3):
    chunks = search(tenant_id, query_text, top_n=top_n)
    if not chunks:
...
if __name__ == "__main__":
    ...
    query = "¿Qué hago si se me poncha una rueda en la carretera?"

    print(f"Pregunta: {query}\n")
    respuesta = rag_query(tenant_id, query)
    print(respuesta)